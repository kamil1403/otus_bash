...
### ✅ Результат:   
- [x] Отчет формируется и отправляетя в Telegram-бот, со всей необходимой информацией из задания выше. Результат см. на скриншоте 🖼️ ["watchlog.timer"](https://github.com/kamil1403/otus_systemd/blob/main/screenshots/watchlog.timer.png)     
