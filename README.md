...
(признаюсь честно 😊 - поднимать и настраивать почтовый сервер ради проверки ДЗ было лень, хоть и есть понимание. Поэтому решил сделать отчет альтернативным способом - через Telegram-бота).   
